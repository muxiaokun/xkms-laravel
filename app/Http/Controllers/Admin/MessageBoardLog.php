...
class MessageBoardLog extends Backend
{
    ...
    public function index()
    {
        ...
        foreach ($messageBoardLogList as &$messageBoardLog) {
            $messageBoardLog['admin_name']  = ($messageBoardLog['audit_id']) ? $AdminModel->mFindColumn($messageBoardLog['audit_id'], 'admin_name') : trans('none') . trans('audit');
        ...
        $whereInfo['add_time'] = array('type' => 'time', 'name' => trans('send') . trans('time'));
    ...
    public function edit()
    {
        ...
        $editInfo['admin_name']  = ($editInfo['audit_id']) ? $AdminModel->mFindColumn($editInfo['audit_id'], 'admin_name') : trans('none') . trans('audit');
