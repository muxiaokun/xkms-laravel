...
class CreateArticlesTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('articles', function (Blueprint $table) {
            ...
            $table->integer('user_id')->unsigned()->comment('发布人编号');
            ...
            $table->integer('hits')->unsigned()->comment('点击量');
            $table->mediumText('extend')->nullable()->comment('扩展信息');
            $table->mediumText('attribute')->nullable()->comment('文章属性');
            $table->mediumText('album')->nullable()->comment('相册信息');
        });
    }
