...
class CreateArticleCategoriesTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('article_categories', function (Blueprint $table) {
            ...
            $table->mediumText('manage_id')->nullable()->comment('分类管理员');
            $table->mediumText('manage_group_id')->nullable()->comment('分类管理组');
            ...
            $table->mediumText('extend')->nullable()->comment('扩展配置');
            $table->mediumText('attribute')->nullable()->comment('属性配置');
