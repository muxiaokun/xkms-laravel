...
M_itlink_editor.prototype = 
{
    ...
    'add_btn_obj':Array(
        ...
        lang.common.add + '(' + lang.common.none + lang.common.image + ')</button>'
    ).join(''),
    'itlink_obj':Array(
    ...
    'itlink_tr_obj':Array(
        ...
        '<div mtype="itl_image" class="default_image" title="' + lang.common.click + lang.common.edit + '">',
                        '<img />',
        ...
        lang.common.link + '(' + lang.common.name + '/' + lang.common.attribute + ')',
                        '</label>',
                        '<div class="col-sm-6">',
        '<input mtype="itl_text" class="form-control" placeholder="' + lang.common.link + lang.common.name + '"  />',
                        '</div>',
                        '<div class="col-sm-2">',
                        ...
                        '</div>',
                        '<div class="col-sm-2">',
        '<button mtype="remove_btn" class="btn btn-default" type="button" >' + lang.common.del + '</button>',
                        '</div>',
                    '</div>',
                    '<div class="form-group">',
        '<label class="col-sm-2 control-label">' + lang.common.link + '</label>',
                        '<div class="col-sm-10">',
        '<input mtype="itl_link" class="form-control" placeholder="' + lang.common.link + '" />',
                        '</div>',
                    '</div>',
