...
M_itlink_editor.prototype = 
{
    ...
    'add_btn_obj':Array(
        ...
        $Think.lang.add + '(' + $Think.lang.none + $Think.lang.image + ')</button>'
    ).join(''),
    'itlink_obj':Array(
    ...
    'itlink_tr_obj':Array(
            '<tr mtype="row">',
                '<td class="col-sm-2 text-center">',
                    '<div mtype="itl_image" class="default_image" title="' + $Think.lang.click + $Think.lang.edit + '">',
                        '<img />',
                ...
                '<td class="col-sm-8">',
                    '<div class="form-group">',
                        '<label class="col-sm-2 control-label">',
                            $Think.lang.link + '(' + $Think.lang.name + '/' + $Think.lang.attribute +')',
                        '</label>',
                        '<div class="col-sm-6">',
                            '<input mtype="itl_text" class="form-control" placeholder="' + $Think.lang.link + $Think.lang.name +'"  />',
                        '</div>',
                        '<div class="col-sm-2">',
                        ...
                        '</div>',
                        '<div class="col-sm-2">',
                            '<button mtype="remove_btn" class="btn btn-default" type="button" >' + $Think.lang.del +'</button>',
                        '</div>',
                    '</div>',
                    '<div class="form-group">',
                        '<label class="col-sm-2 control-label">' + $Think.lang.link +'</label>',
                        '<div class="col-sm-10">',
                            '<input mtype="itl_link" class="form-control" placeholder="' + $Think.lang.link +'" />',
                        '</div>',
                    '</div>',
                    '<p class="help-block col-sm-offset-2">',
                        $Think.lang.insite + $Think.lang.colon + 'M/C/A?arg1=argv1,arg2=argv2',
