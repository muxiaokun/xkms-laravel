                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">{$Think.lang.management}{$Think.lang.group}{$Think.lang.name}</label>
                                <div class="col-sm-3">
<input type="text" class="form-control" placeholder="{$Think.lang.management}{$Think.lang.group}{$Think.lang.name}" name="name" value="{$edit_info.name}"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-sm-4 control-label">{$Think.lang.management}{$Think.lang.group}{$Think.lang.explains}</label>
                                <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-sm-4 control-label">{$Think.lang.management}{$Think.lang.group}{$Think.lang.yes}{$Think.lang.no}{$Think.lang.enable}</label>
                                <div class="col-sm-6">
...
<input type="radio" name="is_enable" value="0" <if condition="'0' heq $edit_info['is_enable']">checked="checked"</if> />{$Think.lang.disable}
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">{$Think.lang.management}{$Think.lang.group}{$Think.lang.default}{$Think.lang.privilege}</label>
