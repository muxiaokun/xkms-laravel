                        ...
                        <td class="nowrap">
                            @if ($batch_handle['edit'])
                                <a class="btn btn-xs btn-primary"
                                   href="{{ route('edit',array('id'=>$admin_group['id'])) }}">
                                    @lang('common.edit')
                                </a>
                            @endif
                            ...
                            @if ($batch_handle['del'])
                                <a class="btn btn-xs btn-danger" href="javascript:void(0);"
                                   onClick="return M_confirm('@lang('common.confirm')@lang('common.del'){{ $admin_group['name'] }}?','{{ route('del',array('id'=>$admin_group['id'])) }}')">
                                    @lang('common.del')
                                </a>
                            @endif
                        </td>
