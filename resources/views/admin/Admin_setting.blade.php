        ...
        <div class="panel panel-default">
            ...
            <form method="post" class="form-horizontal"  role="form">
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <label class="radio-inline">
                                    <input type="radio" name="SYS_ADMIN_AUTO_LOG" value="1" @if ('1' heq C('SYS_ADMIN_AUTO_LOG'))checked="checked"@endif >@lang('common.open')
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="SYS_ADMIN_AUTO_LOG" value="0" @if ('0' heq C('SYS_ADMIN_AUTO_LOG'))checked="checked"@endif >@lang('common.close')
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <label class="radio-inline">
                                    <input type="radio" name="SYS_BACKEND_VERIFY" value="1" @if ('1' heq C('SYS_BACKEND_VERIFY'))checked="checked"@endif >@lang('common.open')
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="SYS_BACKEND_VERIFY" value="0" @if ('0' heq C('SYS_BACKEND_VERIFY'))checked="checked"@endif >@lang('common.close')
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-sm-4 control-label">@lang('common.backend')@lang('common.max')@lang('common.lock')@lang('common.time')(@lang('common.second'))</label>
                            <div class="col-sm-7">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-sm-4 control-label">@lang('common.backend')@lang('common.login')@lang('common.timeout')(@lang('common.second'))</label>
                            <div class="col-sm-7">
