                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" placeholder="@lang('common.category')@lang('common.name')" name="name" value="{{ $edit_info['name'] }}"/>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" placeholder="@lang('common.sort')" name="sort" value="{{ $edit_info['sort'] }}" onKeyup="M_in_int(this);" />
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <select name="parent_id" class="form-control input-sm" >
                                        <option value="0">@lang('common.top_level')@lang('common.enable')@lang('common.attribute')/@lang('common.extend')</option>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
<input type="text" class="form-control" placeholder="@lang('common.list')@lang('common.number')" name="s_limit" value="{{ $edit_info['s_limit'] }}" onKeyup="M_in_int(this);" />
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
