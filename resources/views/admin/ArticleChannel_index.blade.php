                ...
                <table class="table table-condensed table-hover">
                    <tr>
                        ...
                        <td class="col-sm-2 nowrap">
                            @if ($batch_handle['add'])
                                <a class="btn btn-xs btn-success" href="{{ route('add') }}">@lang('common.add')@lang('common.channel')</a>
                            @endif
                        </td>
                    </tr>
                    @foreach ($article_channel_list as $article_channel)
                        <tr>
                            ...
                            <td class="nowrap">
                                ...
                                @if ($batch_handle['del'])
                                    &nbsp;|&nbsp;
<a class="btn btn-xs btn-danger" href="javascript:void(0);" onClick="return M_confirm('@lang('common.confirm')@lang('common.del'){{ $article_channel['name'] }}?','{{ route('del',array('id'=>$article_channel['id'])) }}')" >
                                        @lang('common.del')
                                    </a>
                                @endif
                            </td>
