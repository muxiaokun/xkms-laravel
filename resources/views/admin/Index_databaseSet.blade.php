                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="DB_HOST" value="{{ config('DB_HOST') }}"
                                           class="form-control">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                @if (0 < strlen(config('system.db_pwd')))
                                    <div class="col-sm-4"
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="DB_PORT" value="{{ config('DB_PORT') }}"
                                           class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="DB_PREFIX" value="{{ config('DB_PREFIX') }}"
                                           class="form-control">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <a class="btn btn-sm btn-success"
                                       href="{{ route('database_set',array('backup'=>'1')) }}"
