            ...
            <div class="panel-body">
                        ...
                        <td class="nowrap">
                            @if ($batch_handle['add'])
                                <a class="btn btn-xs btn-success"
                                   href="{{ route('Admin::MemberGroup::add') }}">@lang('common.add')@lang('common.management')@lang('common.group')</a>
                            @endif
                        </td>
                    </tr>
                            ...
                            <td class="nowrap">
                                @if ($batch_handle['edit'])
                                    <a class="btn btn-xs btn-primary"
                                       href="{{ route('Admin::MemberGroup::edit',array('id'=>$member_group['id'])) }}">
                                        @lang('common.edit')
                                    </a>
                                @endif
                                ...
                                @if ($batch_handle['del'])
                                    <a class="btn btn-xs btn-danger" href="javascript:void(0);"
                                       onClick="return M_confirm('@lang('common.confirm')@lang('common.del'){{ $member_group['name'] }}?','{{ route('Admin::MemberGroup::del',array('id'=>$member_group['id'])) }}')">
                                        @lang('common.del')
                                    </a>
                                @endif
                            </td>
                ...
                <div class="row">
                            ...
                            <script type="text/javascript">
                                $(function () {
                                    ...
                                    @if ($batch_handle['edit'])
                                        ...
                                        'post_link': '{{ route('Admin::MemberGroup::edit') }}',
                                    ...
                                    @if ($batch_handle['del'])
                                        ...
                                        'post_link': '{{ route('Admin::MemberGroup::del') }}'
                                    });
                                    @endif
                    ...
                    <div class="col-sm-8 text-right">
                        {{ $member_group_list->links('admin.pagination') }}
                    </div>
                </div>
            </div>
        </div>
