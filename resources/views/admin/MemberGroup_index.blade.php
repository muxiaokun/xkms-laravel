...
<a class="btn btn-xs btn-danger" href="javascript:void(0);" onClick="return M_confirm('{{ trans('common.confirm') }}{{ trans('common.del') }}{$member_group.name}?','{:U('del',array('id'=>$member_group['id']))}')" >
                                        {{ trans('common.del') }}
                                    </a>
                                </if>
                            </td>
