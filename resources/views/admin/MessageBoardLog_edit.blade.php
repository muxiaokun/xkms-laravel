            ...
            <div class="panel-body">
                <form method="post">
                    ...
                    <table class="table table-condensed table-hover col-sm-12">
                        <tr>
                            <td>@lang('common.audit')@lang('common.admin')</td><td>{{ $edit_info['admin_name'] }}</td>
                            <td>@lang('common.send')@lang('common.user')</td><td>{{ $edit_info['member_name'] }}</td>
                        </tr>
                        <tr>
                            <td>@lang('common.send')@lang('common.time')</td><td>{{ $edit_info['add_time']|M_date=C('SYS_DATE_DETAIL') }}</td>
                            <td>@lang('common.send') IP</td><td>{{ $edit_info['aip'] }}</td>
                        </tr>
                    </table>
