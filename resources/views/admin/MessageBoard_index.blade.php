            ...
            <div class="panel-body">
                ...
                <table class="table table-condensed table-hover">
                    <tr>
                        ...
                        <th>{$Think.lang.option}</th>
                        <td class="nowrap">
                            <if condition="$batch_handle['add']">
                                <a class="btn btn-xs btn-success" href="{:U('add')}">{$Think.lang.add}{$Think.lang.messageboard}</a>
                            </if>
                        </td>
                    </tr>
...
<a class="btn btn-xs btn-danger" href="javascript:void(0);" onClick="return M_confirm('{$Think.lang.confirm}{$Think.lang.del}{$message_board.name}?','{:U('del',array('id'=>$message_board['id']))}')" >
                                        {$Think.lang.del}
                                    </a>
                                </if>
                            </td>
