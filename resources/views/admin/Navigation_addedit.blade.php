            ...
            <form id="form_valid" onSubmit="return false;" class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control"
                                       placeholder="@lang('common.navigation')@lang('common.name')" name="name"
                            ...
                            <div class="col-sm-3">
                                <label class="radio-inline">
                                    <input type="radio" name="is_enable" value="1"
                                           @if ('1' heq $edit_info['is_enable'] or !isset($edit_info['is_enable']))checked="checked"@endif />@lang('common.enable')
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="is_enable" value="0"
                                           @if ('0' heq $edit_info['is_enable'])checked="checked"@endif />@lang('common.disable')
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <table id="edit_window" class="table table-condensed table-hover">
                        ...
                        <tr>
                            <td><input class="form-control" type="text" name="nav_text" value="" style="width:100%"/>
                            </td>
                            <td>
                            ...
                            <td colspan="2"><input class="form-control" type="text" name="nav_link" value=""
                                                   style="width:100%"/></td>
                        </tr>
                    </table>
