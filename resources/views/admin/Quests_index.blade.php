            ...
            <div class="panel-body">
                ...
                <table class="table table-condensed table-hover">
                    <tr>
                        ...
                        <td class="nowrap">
                            @if ($batch_handle['add'])
                                <a class="btn btn-xs btn-success" href="{{ route('add') }}">@lang('common.add')@lang('common.quests')</a>
                            @endif
                        </td>
                    </tr>
                    @foreach ($quests_list as $quests)
                        <tr>
                            ...
                            <td class="nowrap">
                                ...
                                @if ($batch_handle['del'])
<a class="btn btn-xs btn-danger" href="javascript:void(0);" onClick="return M_confirm('@lang('common.confirm')@lang('common.clear'){{ $quests['title'] }}@lang('common.answer')?',
'{{ route('del',array('id'=>$quests['id'],'clear'=>1)) }}')" >
                                        @lang('common.clear')@lang('common.answer')
                                    </a>
                                    &nbsp;|&nbsp;
<a class="btn btn-xs btn-danger" href="javascript:void(0);" onClick="return M_confirm('@lang('common.confirm')@lang('common.del'){{ $quests['title'] }}?','{{ route('del',array('id'=>$quests['id'])) }}')" >
                                        @lang('common.del')
                                    </a>
                                @endif
                            </td>
