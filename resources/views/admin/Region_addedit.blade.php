            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" action="" method="post">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-sm-4 control-label">@lang('region.region_name')</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" placeholder="@lang('region.region_name')"
                                           name="region_name" value="{{ $edit_info['region_name'] }}"
                                           onchange="M_zh2py(this,'input[name=all_spell]',true);M_zh2py(this,'input[name=short_spell]')"
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-sm-4 control-label">@lang('region.short_name')</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" placeholder="@lang('region.short_name')"
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-sm-4 control-label">@lang('region.all_spell')</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" placeholder="@lang('region.all_spell')"
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-sm-4 control-label">@lang('region.short_spell')</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" placeholder="@lang('region.short_spell')"
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-sm-4 control-label">@lang('region.areacode')</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" placeholder="@lang('region.areacode')"
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-sm-4 control-label">@lang('region.postcode')</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" placeholder="@lang('region.postcode')"
