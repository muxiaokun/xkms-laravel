                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" placeholder="@lang('common.areacode')"
                                       name="areacode" value="{{ $edit_info['areacode'] }}" onKeyup="M_in_int(this);"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" placeholder="@lang('common.postcode')"
                                       name="postcode" value="{{ $edit_info['postcode'] }}" onKeyup="M_in_int(this);"/>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-sm-4">
                                <label class="radio-inline">
                                    <input type="radio" name="if_show" value="1"
                                           @if ('1' heq $edit_info['if_show'])checked="checked"@endif />@lang('common.show')
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="if_show" value="0"
                                           @if ('0' heq $edit_info['if_show'] or !isset($edit_info['if_show']))checked="checked"@endif />@lang('common.hidden')
                                </label>
                            </div>
                        </div>
                    </div>
