                        ...
                        <div class="col-sm-8 text-center">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" onchange="window.location.href = $(this).val()">
                                    <option value="{:U('index',array('default_theme'=>'empty'))}">{{ trans('common.please') }}{{ trans('common.selection') }}{{ trans('common.or') }}{{ trans('common.empty') }}</option>
                        ...
                        <tr>
                            ...
                            <td class="nowrap">
                                <if condition="$batch_handle['add']">
                                    <a class="btn btn-xs btn-success" href="{:U('add')}">{{ trans('common.add') }}{{ trans('common.template') }}</a>&nbsp;|&nbsp;
                                </if>
                                <a class="btn btn-xs btn-success" href="{:U('index',array('refresh'=>1))}">{{ trans('common.refresh') }}{{ trans('common.template') }}{{ trans('common.list') }}</a>
                            </td>
                        </tr>
    ...
    <a class="btn btn-xs btn-danger" href="javascript:void(0);" onClick="return M_confirm('{{ trans('common.confirm') }}{{ trans('common.del') }}{$template.file_name}?','{:U('del',array('id'=>$file_md5))}')" >
                                            {{ trans('common.del') }}
                                        </a>
                                    </if>
                                </td>
