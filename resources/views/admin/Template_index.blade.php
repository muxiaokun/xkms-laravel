                            ...
                            @if ($theme_list)
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control" onchange="window.location.href = $(this).val()">
                                        <option value="{{ route('Admin::Template::index',array('default_theme'=>'empty')) }}">@lang('common.please')@lang('common.selection')@lang('common.or')@lang('common.empty')</option>
                                        @foreach ($theme_list as $theme)
                                            <option value="{{ route('Admin::Template::index',array('default_theme'=>$theme)) }}"
                            ...
                            <td class="nowrap">
                                @if ($batch_handle['add'])
                                    <a class="btn btn-xs btn-success"
                                       href="{{ route('Admin::Template::add') }}">@lang('common.add')@lang('common.template')</a>
                                    &nbsp;|
                                    &nbsp;
                                @endif
                                <a class="btn btn-xs btn-success"
                                   href="{{ route('Admin::Template::index',array('refresh'=>1)) }}">@lang('common.refresh')@lang('common.template')@lang('common.list')</a>
                            </td>
                        </tr>
                                ...
                                <td class="nowrap">
                                    @if ($batch_handle['edit'])
                                        <a class="btn btn-xs btn-primary"
                                           href="{{ route('Admin::Template::edit',array('id'=>$file_md5)) }}">
                                            @lang('common.edit')
                                        </a>
                                    @endif
                                    ...
                                    @if ($batch_handle['del'])
                                        <a class="btn btn-xs btn-danger" href="javascript:void(0);"
                                           onClick="return M_confirm('@lang('common.confirm')@lang('common.del'){{ $template['file_name'] }}?','{{ route('Admin::Template::del',array('id'=>$file_md5)) }}')">
                                            @lang('common.del')
                                        </a>
                                    @endif
                                </td>
