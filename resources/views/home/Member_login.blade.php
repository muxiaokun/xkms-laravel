    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <ul id="login_tab" class="nav nav-tabs" role="tablist">
                <li
                @if (register != request('t')">class="active"@endif ><a href="#login" role="tab" data-toggle="tab)@lang('common.login')@lang('common.account')</a></li>
                <li
                @if (register == request('t')">class="active"@endif ><a href="#register" role="tab" data-toggle="tab)@lang('common.register')@lang('common.account')</a></li>
            </ul>
            ...
            = "form-group" >
                    < label
            class
            = "col-sm-3 control-label" >@lang('common.account')< / label >
                    < div
            class
            = "col-sm-5" >
                    < input
            ...
            class
            = "form-control"
            placeholder = "@lang('common.account')"
            name = "re_member_name" / >
                    < / div >
                    < / div >
                    < div
            ...
            = "form-group" >
                    < label
            class
            = "col-sm-3 control-label" >@lang('common.input')@lang('common.pwd')< / label >
                    < div
            class
            = "col-sm-5" >
                    < input
            ...
            = "form-group" >
                    < label
            class
            = "col-sm-3 control-label" >@lang('common.again')@lang('common.input')< / label >
                    < div
            class
            = "col-sm-5" >
                    < input
            ...
            = "form-group" >
                    < label
            class
            = "col-sm-3 control-label" >@lang('common.verify_code')< / label >
                    < div
            class
            = "col-sm-5" >
                    < input
            ...
            src = "{:M_U('verify_img',array('t'=>'register'))}"
            onClick = "M_change_verify(this,$('input[name=verify]'))" / >
                    < / div >
                    {{--验证码 结束--}}
                    @endif
            ...
            type = "submit"
            class
            = "btn btn-info col-sm-offset-5"
            value = "@lang('common.register')" >
                    < / form >
                    < / div >
                    < / div >
                    < / div >
